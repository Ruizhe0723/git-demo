...
![xkcd 1597](https://raw.githubusercontent.com/Ruizhe0723/my_PicGo/main/img/202207041850642.png)
...
- `git cat-file -p xxxx`查看文件

- `git log`: 显示历史日志

- `git log --all --graph --decorate`: 可视化历史记录（有向无环图）

- `git log --all --graph --decorate --oneline`: 可视化历史记录（一行显示）
...
- `.gitignore`: [指定](https://git-scm.com/docs/gitignore) 故意不追踪的文件【把文件名和文件形式写入该文件就行了】
